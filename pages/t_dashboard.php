			...
			<div class="row">
				...
				<h4 class="page-header" style="text-align:center;"  > <?php echo strtoupper("welcome"." ".htmlentities($_SESSION['login']));?></h4>
                    ...
                    <div align="center">
                        ...
                        <p style="font-family:cursive; "text-align:left>Bangalore Institute of Technology was started in the year 1979 with the objective of providing quality education in the ?eld of Technology and thereby serving the society. It has reached enviable level of excellence in technical education. The college thrives to achieve the all-round development of the students.</p>
