...
if(isset($_POST['update'])){
		...
		$id=$_GET['sid'];
	$obj->edit_subject($_POST['sub1'],$_POST['sub2'],$_POST['sub3'],$_POST['sub4'],$_POST['sub5'],$_POST['sub6'],$id);
    header ( 'location:../pages/view-subject.php' );
...
<input class="form-control" name="sub3" id="sub3" value="<?php echo $res->sub3;?>" required="required">         
    ...
    <br><br>
		...
		<div class="col-lg-6">
<input class="form-control" name="sub4" id="sub4" value="<?php echo $res->sub4;?>" required="required">         
		</div>
	 </div>
    <br><br>
                                <div class="form-group">
		...
		<div class="col-lg-6">
<input class="form-control" name="sub5" id="sub5" value="<?php echo $res->sub5;?>" required="required">         
		</div>
	 </div>
    <br><br>
                                <div class="form-group">
		...
		<div class="col-lg-6">
<input class="form-control" name="sub6" id="sub6" value="<?php echo $res->sub6;?>" required="required">         
		</div>
	 </div>
