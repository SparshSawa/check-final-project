...
<body style="background : url(../images/test.jpg)">
    ...
    <div class="heading" style="text-align: center; color:white; margin-top: 60px; font-family:serif;">           
    ...
    <div class="container" id="home">
        <div class="row text-center">
            <div class="col-md-12">
               ...
               <a href="http://localhost/check final project\pages/t_login.php" class="btn btn-danger btn-lg head-btn-one"> TEACHER'S LOGIN</a> &nbsp  &nbsp  &nbsp  &nbsp; 
