...
<body>
    ...
    <div id="wrapper">
     ...
     <?php include('leftbar.php')?>;
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Parent's/ Guardian's Mob.No.</th>
                                            <th>Address</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
	  ...
	  <td><?php echo htmlentities(strtoupper($res->branch));?></td>
      <td><?php echo htmlentities(strtoupper($res->pname));?></td>	
    <td><?php echo htmlentities(strtoupper($res->pmob));?></td>
    <td><?php echo htmlentities(strtoupper($res->padd));?></td>
      <td>&nbsp;<a href="edit-std.php?id=<?php echo htmlentities($res->usn);?>">
	  <p class="fa fa-edit"></p></a> &nbsp;
          <a href="view-personal.php?del=<?php echo htmlentities($res->usn); ?>">
